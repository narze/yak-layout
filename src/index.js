...
const LAYOUTS = {
  ...
  PATTACHOTE: {
    keys: [
      /* Row 0: */ '⎋', 'F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'F9', 'F10', 'F11', 'F12', '⌽',
      /* Row 1: */ ['฿', ' '], [' ', ' '], ['๒', '"'], ['๓', '/'], ['๔', ','], ['๕', '?'], ['ู', 'ุ'], ['๗', '_'], ['๘', '.'], ['๙', '('], ['๐', ')'], ['๑', '-'], ['๖', '%'], '⌫',
      /* Row 2: */ '⇥', ['็', '๊'], ['ต', 'ฤ'], ['ย', 'ๆ'], ['อ', 'ญ'], ['ร', 'ษ'], ['่', 'ึ'], ['ด', 'ฝ'], ['ม', 'ซ'], ['ว', 'ถ'], ['แ', 'ฒ'], ['ใ', 'ฯ'], ['ฌ', 'ภ'], ['ฃ', 'ฅ'],
      /* Row 3: */ '⇪', ['้', '๋'], ['ท', 'ธ'], ['ง', 'ำ'], ['ก', 'ณ'], ['ั', '์'], ['ี', 'ื'], ['า', 'ผ'], ['น', 'ช'], ['เ', 'โ'], ['ไ', 'ฆ'], ["ข", 'ฑ'], '↩',
      /* Row 4: */ '⇧ (Left)', ['บ', 'ฎ'], ['ป', 'ฏ'], ['ล', 'ฐ'], ['ห', 'ภ'], ['ิ', 'ั'], ['ค', 'ศ'], ['ส', 'ฮ'], ['ะ', 'ฟ'], ['จ', 'ฉ'], ['พ', 'ฬ'], '⇧ (Right)',
      /* Row 5: */ 'fn', '⌃ (Left)', '⌥ (Left)', '⌘ (Left)', '␣', '⌘ (Right)', '⌥ (Right)', '←', '↑', '↓', '→',
    ],
    name: 'Pattachote',
  },
